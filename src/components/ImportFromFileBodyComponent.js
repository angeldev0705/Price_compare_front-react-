...
import {
    ...
    export default ({...props}) => {
        ...
        return (
                      ...
                      {({getRootProps, getInputProps}) => (
                        <section>
                          <div {...getRootProps()}>
                            ...
                            <p>Drag 'n' drop the .csv file here<br/>
                ...
                hidden
                />
                <Button variant="primary" type="button" onClick={() => {document.getElementById('file').click()}} className="submit-request">Upload CSV File</Button>
                </div>
                </div>
                </div>
            )
